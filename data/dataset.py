...
if __name__ == "__main__":
    # Test the dataset - only run when explicitly called as a script
    ...
    # Don't create files automatically - just test if they exist
    if not os.path.exists(metadata_path):
        print(f"Metadata file not found at {metadata_path}")
        print("Please ensure AudioCaps dataset is properly set up.")
        exit(1)
